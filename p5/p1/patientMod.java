...
public class patientMod extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	//	q.add(bu);
		...
		tadd=new TextArea(patientm.addr);
...
public void read()
	{
		try
		{
			//patientm.dt=""+tdt.getText();
			patientm.pid=Integer.parseInt(tpid.getText());
			patientm.pfnm=tpfnm.getText();
			patientm.pmnm=tpmnm.getText();
			patientm.plnm=tplnm.getText();
			patientm.gen=cbg.getSelectedCheckbox().getLabel();
		
			try
			{
				patientm.age=Integer.parseInt(tage.getText());
				tage.setText(""+patientm.age);
				
			}
			catch(Exception e)
			{
					JOptionPane.showMessageDialog(null,"Invalid age inputed.");
					patientm.age=Integer.parseInt(JOptionPane.showInputDialog("Please enter valid age:"));
					tage.setText(""+patientm.age);
			}
			...
			patientm.wt=twt.getText();
			patientm.addr=tadd.getText();
			this.ad=tadd.getText();
			System.out.println(tadd.getText());
			
			while(true)
			{
					patientm.cno=tcno.getText();
					if(patientm.cno.length()==10)
						break;
					else
					{
						JOptionPane.showMessageDialog(null,"Invalid Phone No.");
						patientm.cno=JOptionPane.showInputDialog("Please enter valid 10-digit Phone No.:");
						tcno.setText(patientm.cno);
					}
			}
			patientm.dnm=tdnm.getText();
			patientm.sym=tsym.getText();
			System.out.println(tsym.getText());

			patientm.dig=tdig.getText();
			try
			{
				patientm.fee=Integer.parseInt(tfee.getText());
				tfee.setText(""+patientm.fee);
				
			}
			catch(Exception e)
			{
					JOptionPane.showMessageDialog(null,"Invalid Fee inputed.");
					patientm.fee=Integer.parseInt(JOptionPane.showInputDialog("Please enter valid Fee:"));
					tfee.setText(""+patientm.fee);
			}
		
			patientm.bg=tbg.getText();
			patientm.path=str;
		}
		catch (Exception e)
		{
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tpid)
		{
			...
			if(res)
			{
				...
				try
				{
					dt1=patientm.rs.getString(1);
					no=patientm.rs.getInt(2);
					pfn=patientm.rs.getString(3);
					pmn=patientm.rs.getString(4);
					pln=patientm.rs.getString(5);
					gender=patientm.rs.getString(6);
					ag=patientm.rs.getInt(7);
					wgt=patientm.rs.getString(8);
					add=patientm.rs.getString(9);
					cn=patientm.rs.getString(10);
					dn=patientm.rs.getString(11);
					sym=patientm.rs.getString(12);
					dig=patientm.rs.getString(13);
					fee=patientm.rs.getInt(14);
					bg=patientm.rs.getString(15);
						dir=patientm.rs.getString(17);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==bm)
		{
			try
			{
				read();
				patientm.mod(f,str);
				JOptionPane.showMessageDialog(null,"Patient ID: "+patientm.pid+" Record Modified");
			}
			catch (Exception e5)
			{
			}
