 ...
 class patientdi 
{
 ...
 class disptabledi extends JFrame implements ActionListener
{
	JTable jt;
	JButton btn;
...
public class 	patientDis extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	//	q.add(bu);
		...
		tadd=new TextArea(patientdi.addr);
...
//		q.add(lcno);
	...
	public void read()
	{
		try
		{
			//patientdi.dt=""+tdt.getText();
			patientdi.pid=Integer.parseInt(tpid.getText());
			patientdi.pfnm=tpfnm.getText();
			patientdi.pmnm=tpmnm.getText();
			patientdi.plnm=tplnm.getText();
			patientdi.gen=cbg.getSelectedCheckbox().getLabel();
			patientdi.age=Integer.parseInt(tage.getText());
			patientdi.wt=twt.getText();
			patientdi.addr=tadd.getText();
			this.ad=tadd.getText();
			System.out.println(tadd.getText());
			patientdi.cno=tcno.getText();
			patientdi.dnm=tdnm.getText();
			patientdi.sym=tsym.getText();
			System.out.println(tsym.getText());

			patientdi.dig=tdig.getText();
			patientdi.fee=Integer.parseInt(tfee.getText());
			patientdi.bg=tbg.getText();
			patientdi.path=str;
		}
		catch (Exception e)
		{
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tpid)
		{
			...
			if(res)
			{
				...
				try
				{
					dt1=patientdi.rs.getString(1);
					no=patientdi.rs.getInt(2);
					pfn=patientdi.rs.getString(3);
					pmn=patientdi.rs.getString(4);
					pln=patientdi.rs.getString(5);
					gender=patientdi.rs.getString(6);
					ag=patientdi.rs.getInt(7);
					wgt=patientdi.rs.getString(8);
					add=patientdi.rs.getString(9);
					cn=patientdi.rs.getString(10);
					dn=patientdi.rs.getString(11);
					sym=patientdi.rs.getString(12);
					dig=patientdi.rs.getString(13);
					fee=patientdi.rs.getInt(14);
					bg=patientdi.rs.getString(15);
						dir=patientdi.rs.getString(17);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==bl)
		{
			disptabledi obj=null;
			try
			{
				obj=new disptabledi(patientdi.collectRows());
			}
			catch (Exception e7)
			{
			}
