...
{
	JLabel lmid,lmnm,lmnf,ltp,lprc,lqty,j00,j01;
	...
	public medicineRem(String s)
	{
		...
		setFont(f);
		j00=new JLabel("CLICK REMOVE STOCK");
			j00.setFont(f);
			c1=new Color(2,0,0);
			j00.setForeground(c1);
		j01=new JLabel("ENTER MEDICINE NAME AND REMOVED MEDICINE QUANTITY");
			j01.setFont(f);
	...
	//	p.add(bg);
		...
		j00.setBounds(230,100,400,30);
		q.add(j00);
			j01.setBounds(80,150,600,30);
		q.add(j01);
		bg.setBounds(255,250,150,30);
		q.add(bg);
